...
import CourseGuid from '../../Components/Students/CourseGuid'
...
const CoursesList = () => {
  ...
  return (
    <>
    <div className='relative md:px-26 px-8 pt-20 text-left'>
  ...
  <h1 className='text-4xl font-semibold text-gray-800'>Course List</h1>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-16 gap-3 px-2 md:p-0'>
        {filteredCourse.map((course, index)=> <CourseGuid key={index} course={course}/>)}
      </div>
    </div>
  <Footer/>
    </>
