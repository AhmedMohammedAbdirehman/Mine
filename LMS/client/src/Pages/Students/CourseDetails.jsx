  ...
  return courseData ? (
   <>
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <p className='pt-4 md:text-base text-sm'
       ...
       {/* course review and rating */}
        <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                 ...
                 <div className='flex'>
                   {[...Array(5)].map((_, i)=>(
                     <img key={i} src={i<Math.floor(calculateRating(courseData))? assets.star: assets.star_blank} alt='stars'  className='w-3.5 h-3.5'/>
                   ))}
                 </div>
               ...
               <p className='text-sm'>Course by <span className='text-blue-600 underline'>Ahmed Mohammed</span></p>
     ...
     {/* right column */}
     <div className='max-w-[800px] z-10 shadow-md shadow-gray-500 rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
     ...
     
     {
       ...
       <div className='flex items-center gap-2'>
        ...
        <img className='w-3.5' src={assets.time_left_clock_icon} alt="time logo" />
     ...
     <p className='md:text-lg text-gray-700 line-through'>{currency} {courseData.coursePrice}</p>
