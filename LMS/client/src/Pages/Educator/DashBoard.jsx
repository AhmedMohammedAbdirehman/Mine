        ...
        <div className='flex flex-wrap gap-5 items-center'>
          ...
          <div className='flex items-center gap-3 shadow border border-blue-500 p-4 w-56 rounded-md'>
            ...
            <div>
              ...
              <p className='text-base text-gray-5000'Total Enrollments></p>
            </div>
          </div>
          ...
          <div className='flex items-center gap-3 shadow border border-blue-500 p-4 w-56 rounded-md'>
            ...
            <div>
              ...
              <p className='text-base text-gray-5000'Total Courses></p>
            </div>
          </div>
          ...
          <div className='flex items-center gap-3 shadow border border-blue-500 p-4 w-56 rounded-md'>
            ...
            <div>
              ...
              <p className='text-base text-gray-5000'Total Earnings></p>
            </div>
          </div>
