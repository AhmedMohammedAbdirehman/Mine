    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 pt-8 pb-0'>
      <form onSubmit={handleSubmit}>
        <div className='flex flex-col gap-1'>
          <p>Course Title</p>
          <input onChange={e=>setCourseTitle(e.target.value)} value={courseTitle} type="text" name="" id=""  placeholder='Type here' className='outline-none md:py-2.5 py-2 rounded border border-gray-800' required/>
        </div>
       <div className='flex flex-col gap-1'>
